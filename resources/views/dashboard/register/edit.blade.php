...
<div class="col-lg-8">
    <form action="/dashboard/register/{{ $register->id }}" method="post" class="mb-5">
        ...
        <div class="mb-3">
            ...
            is-invalid
            @enderror" name="check_in" id="check_in" value="{{ old('check_in',$register->check_in) }}">
            @error('check_in')
        ...
        <div class="mb-3">
            ...
            is-invalid
            @enderror" name="check_out" id="check_out" value="{{ old('check_out',$register->check_out) }}">
            @error('check_out')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('register_type') is-invalid @enderror" id="register_type" name="register_type"
                value="{{ old('register_type',$register->register_type) }}">
            @error('register_type')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
