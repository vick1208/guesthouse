...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/dashboard/transaction/{{ $transaction->id }}" method="post" class="row mb-5">
            @method('put')
            @csrf
            <div class="col-md-3 mb-3">
                <label for="room_id" class="form-label">Kamar
                </label>
                <select class="form-select" name="room_id" id="room_id">

                    @foreach ($rooms as $room)
                        @if (old('room_id', $transaction->room->id) == $room->id)
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('guest_name') is-invalid @enderror" id="guest_name"
                    name="guest_name" value="{{ old('guest_name', $transaction->guest_name) }}">
            ...
            <div class="col-md-3 mb-3">
                ...
                <select class="form-select" name="payment_id" id="payment_id">
                    ...
                    @foreach ($pays as $pay)
                        @if (old('payment_id', $transaction->payment->id) == $pay->id)
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('paid_price') is-invalid @enderror"
                    id="paid_price" name="paid_price" value="{{ old('paid_price', $transaction->paid_price) }}">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('pay_status') is-invalid @enderror" id="pay_status"
                    name="pay_status" value="{{ old('pay_status', $transaction->pay_status) }}">
