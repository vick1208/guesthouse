...
<div class="col-lg-8">
    <form action="/dashboard/reserve" method="post" class="mb-5">
        ...
        <div class="mb-3">
            <label for="reserved" class="form-label">Reservasi dari</label>
            <input type="text" class="form-control @error('reserved') is-invalid @enderror" id="reserved" name="reserved"
                value="{{ old('reserved') }}">
            @error('reserved')
                <div class="invalid-feedback">
                    {{ $message }}
